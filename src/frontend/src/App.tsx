        ...
        <div className="flex items-center justify-between h-14">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <span className="text-terminal-buy font-mono font-bold text-base">
                ▶
              </span>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-1 px-2 py-0.5 rounded border border-border bg-muted/20">
              ...
              <span className="text-[10px] font-mono text-terminal-buy/70">
                5u2c6…cai
              </span>
            </div>
          </div>
...
function Footer() {
  const appId =
    typeof window !== "undefined" ? window.location.hostname : "icdex-grid-bot";
